...
const sampleHabit2 = {
  ...
  obstacleTemplateIds: [BigInt(2), BigInt(4)],
  state: GoalState.active,
  isLockIn: false,
  themeColor: "#10B981",
  lastEditedAt: undefined,
  ...
  updateHabit: async (habitId, request) => {
    ...
    return {
      ...
      ok: {
        ...
        obstacleTemplateIds: request.obstacleTemplateIds ?? found.obstacleTemplateIds,
