...
const NAV_ITEMS: NavItem[] = [
  // 'My Goals' is the very first item in the hamburger menu per the user
  // instruction "My Goals at top of hamburger menu". It routes to the new
  // /my-goals page (macro goals + nested habits). Uses the Goal icon from
  // lucide-react to distinguish it from 'My Habits' (Target icon) below.
  { to: "/my-goals", icon: Goal, label: "My Goals" },
