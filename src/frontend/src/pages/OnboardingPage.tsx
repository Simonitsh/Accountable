  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Step indicator — single username step */}
          <div className="flex items-center justify-center gap-3 mb-6">
            <span className="flow-step active" data-ocid="onboarding.step.1">
              1
            </span>
          </div>
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Your username is permanent and must be unique. You can personalize
              your avatar later from your profile.
            </p>
          </div>
