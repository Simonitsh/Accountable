...
module {
  ...
  /// Updates an editable macro goal. Only the `updatedAt` timestamp is
  /// refreshed; wish/wishDescription/outcome/category are immutable after
  /// creation. Macro goals never carry a custom color or icon.
